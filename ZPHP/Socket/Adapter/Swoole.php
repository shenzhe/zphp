...
class Swoole implements IServer
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->serv->set(array(
            ...
            'heartbeat_idle_time' => empty($config['heartbeat_idle_time']) ? 30 : $config['heartbeat_idle_time'],
            'heartbeat_check_interval' => empty($config['heartbeat_check_interval']) ? 30 : $config['heartbeat_check_interval'],
